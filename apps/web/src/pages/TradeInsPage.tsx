...
export default function TradeInsPage() {
  ...
  return (
    <div className={`${shell.default} space-y-5`}>
      <PageHeader title="Trade-Ins" subtitle="Devices accepted in exchange" icon={ArrowLeftRight}
        actions={<button onClick={() => setShowAdd(true)} className={btn.primary}><Plus size={15} /> Add trade-in</button>} />
