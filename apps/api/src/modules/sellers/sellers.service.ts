...
export class SellersService {
  ...
  async update(sellerId: string, body: { shopName?: string; phone?: string; address?: string; murabahaMode?: boolean; settings?: { dailyTarget?: number; weeklyTarget?: number; monthlyTarget?: number } }) {
